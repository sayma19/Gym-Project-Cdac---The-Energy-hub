...
<div class="form-group">
  ...
  <input name="email" placeholder="DD/MM/YY" class="form-control"  type="text">
    </div>
  </div>
</div>
 <div class="form-group">
  ...
  <input name="email" placeholder="write here" class="form-control"  type="text">
    </div>
  </div>
</div>-->
...
<div class="col-md-4 inputGroupContainer">
<lable class="container">Yes
<input type="radio" checked="checked" name="radio">
<span class="checkmark" ></span>
</lable>

<lable class="container">No
<input type="radio" checked="checked" name="radio">
<span class="checkmark" ></span>
</lable>
</div>
