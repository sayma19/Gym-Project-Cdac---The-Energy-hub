...
<nav class="navbar navbar-inverse navbar-static-top">
  ...
  <div class="container-fluid">
	...
	<td>
                            ...
                            <a  href="/SpringHiberGym/editMembers/${a.member_id}" class="edit" title="Edit" data-toggle="tooltip">Edit</a>
                            <a href="/SpringHiberGym/deleteMembers/${a.member_id}" class="delete" title="Delete" data-toggle="tooltip">Delete</a>
                        </td>
                    </tr>
                    </c:forEach>
